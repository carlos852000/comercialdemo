...
@Component({
  selector: 'vex-ingreso-transferencias',
  templateUrl: './ingreso-transferencias.component.html',
  styleUrls: ['./ingreso-transferencias.component.scss'],
  animations: [stagger60ms, fadeInUp400ms, scaleIn400ms, fadeInRight400ms],
})
export class IngresoTransferenciasComponent implements OnInit {
  ...
  validaBotones(idacceso) {
    this.permisosService
      .validaAccesoBoton(idacceso, "btnINGRESO-TRANSFERENCIA-NUEVO")
    ...
    this.permisosService
      .validaAccesoBoton(idacceso, "btnINGRESO-TRANSFERENCIA-EDITAR")
      .subscribe((responseBoton) => {
        if (responseBoton.dato.permiso == 1) {
    ...
    this.permisosService
      .validaAccesoBoton(idacceso, "btnINGRESO-TRANSFERENCIA-ELIMINAR")
      .subscribe((responseBoton) => {
        if (responseBoton.dato.permiso == 1) {
